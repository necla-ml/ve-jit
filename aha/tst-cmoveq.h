...
#if NARGS == 1
int_least32_t userfun(int_least32_t x)
#else
int_least32_t userfun(int_least32_t x, int_least32_t y)
#endif
{
    // x-->x (identity) except for x==2 which outputs '3'
#if 1
    // x-->x, except 2-->3
    // asm:
    //   sub r1,rx,2
    //   add r2,rx,1
    //   cmoveq r3,rx,r1,r2  // if(r1 ie rx==2) r3=r2; else r3=r2;   rx=r3
    // FOUND:
    //   sub    r1,rx,2
    //   cmoveq r2, rx,r1,3
    int y = x-2;
    ...
    x = (y==0? z: x);
#elif 1
    // asm: -1 maps to 2, o.w. identity
    //   add r1,rx,1
    //   cmoveq r2,rx,r1,2  // if(r1 ie rx==2) r3=r2; else r3=r2;   rx=r3
    int r1 = x-3;
    x = (r1==0? 2: x);
    //x = (r1==0? 2: r1); // x-->x-3 except 3-->2
    //... sub    r1,rx,3
    //    cmoveq r2,r1,r1,2
#else
    int r1 = x-3;
...
int trialx[] = {1, 0, -1, -2, 2, 3, (int)MAXNEG, (int)MAXPOS, \
   (int)(MAXNEG + 1), (int)(MAXPOS - 1), (int)0x01234567, (int)0x89ABCDEF, \
   -64, 64, -5, -31415};
#if NARGS == 1
...
int _mrg(int x, int y, int z) {return /*x=*/(x&(~z))|(y&z);}//bitwise merge
...
int cmoveq(int x, int y, int z) {return /*x=*/ y == 0 ? z : x;}
int cmovgt(int x, int y, int z) {return /*x=*/ y  > 0 ? z : x;}
int cmovlt(int x, int y, int z) {return /*x=*/ y  < 0 ? z : x;}
