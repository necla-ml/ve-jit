...
/** mod_inverse is best kept for cases where exact divisibility is
 * known.  When a%d is nonzero, a*mod_inverse(d) is kind of random,
 * and only rarely can be shifted into some correct value of floor(a/d).
 */
